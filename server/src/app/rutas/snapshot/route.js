...
export async function POST(req) {
  try {
    ...
    console.log(`POST /rutas/snapshot - URL: ${url}`);
    ...
    console.error("Error en POST /rutas/snapshot:", error);
    // Respond cleanly if the site was not found (e.g. tracking code is on an unmonitored site)
    return NextResponse.json(
